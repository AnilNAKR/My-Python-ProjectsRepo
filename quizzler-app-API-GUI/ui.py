...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.window = Tk()
        self.window.title("Trivia API Quiz App")
        ...
        self.question_text = self.canvas.create_text(150, 125, width=280, text="This is Anil", font=("Arial",
                                                                                                     20, "italic"))
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text="You've reached to end of the quiz.\n"
